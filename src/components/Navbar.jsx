...
>
  {link.label}
          ...
          <div className="flex items-center md:hidden">
            ...
            >
              <div className={`w-6 h-0.5 bg-gray-800 transition-all duration-200 ${isOpen ? 'transform rotate-45 translate-y-1.5' : 'mb-1.5'}`} />
              <div className={`w-6 h-0.5 bg-gray-800 transition-all duration-200 ${isOpen ? 'opacity-0' : 'mb-1.5'}`} />
              <div className={`w-6 h-0.5 bg-gray-800 transition-all duration-200 ${isOpen ? 'transform -rotate-45 -translate-y-1.5' : ''}`} />
            </button>
          </div>
        </div>
            ...
            {links.map((link) => (
              <a
                ...
                className={`font-semibold text-center transition-colors duration-200 hover:underline hover:underline-offset-8 
                  ${activeLink === link.href ? "text-[#FF014F]" : "text-black"}`} // Apply active style
                onClick={() => {
                  setActiveLink(link.href);
